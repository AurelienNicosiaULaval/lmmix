...
- [Using lmmix](articles/lmmix.md)
  ([source](https://github.com/AurelienNicosiaULaval/lmmix/blob/main/vignettes/lmmix.Rmd))
  presents the fitting workflow and the main methods;
- [Estimation and inference in lmmix](articles/theory-reml.md)
  ([source](https://github.com/AurelienNicosiaULaval/lmmix/blob/main/vignettes/theory-reml.Rmd))
  gives the mathematical formulation, covariance parameterizations, ML
  and REML criteria, and Satterthwaite inference;
- [Validation strategy and numerical benchmarks](articles/validation.md)
  ([source](https://github.com/AurelienNicosiaULaval/lmmix/blob/main/vignettes/validation.Rmd))
