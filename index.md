...
- [Using
  ...
  ([source](https://aureliennicosiaulaval.github.io/lmmix/vignettes/lmmix.Rmd))
...
- [Estimation and inference in
  ...
  ([source](https://aureliennicosiaulaval.github.io/lmmix/vignettes/theory-reml.Rmd))
  gives the mathematical formulation, covariance parameterizations, ML
  and REML criteria, and Satterthwaite and Kenward-Roger inference;
- [Covariance intervals and boundary-aware model
  comparisons](https://aureliennicosiaulaval.github.io/lmmix/articles/boundary-inference.md)
  ([source](https://aureliennicosiaulaval.github.io/lmmix/vignettes/boundary-inference.Rmd))
  explains bound-respecting covariance intervals and
  parametric-bootstrap likelihood-ratio tests;
- [Validation against independent R implementations and PROC
  ...
  ([source](https://aureliennicosiaulaval.github.io/lmmix/vignettes/validation.Rmd))
  documents the independent comparisons, numerical tolerances, and
  validation boundaries;
- [Choosing lmmix and related R
  packages](https://aureliennicosiaulaval.github.io/lmmix/articles/comparison.md)
  ([source](https://aureliennicosiaulaval.github.io/lmmix/vignettes/comparison.Rmd))
  compares the implemented model and inference scope with `lme4`,
  `lmerTest`, `nlme`, and `mmrm`.
...
| Multiplicity | Any [`stats::p.adjust()`](https://rdrr.io/r/stats/p.adjust.html) method and simultaneous Bonferroni confidence intervals |
| Missing data | `na.omit`, `na.exclude`, or `na.fail` |
| Interoperability | `emmeans`, `tidy()`, `glance()`, and `augment()` |
| Diagnostic plots | [`plot.lmm()`](https://aureliennicosiaulaval.github.io/lmmix/reference/lmm-methods.md) returns `ggplot2` residual, Q-Q, and fitted-value diagnostics |
...
omits rows that are incomplete for variables required by the fixed,
random and repeated formulas. The fitted object therefore records 125
observations for this example. Use `na.action = na.exclude` to restore
...
Printed tables use readable headings without dots, including
`Std Error`, `p value`, `Conf Low`, and `Conf High`. The underlying
objects retain the standard `broom` names required for programmatic use.
...
[`predict()`](https://rdrr.io/r/stats/predict.html) can return standard
errors, confidence intervals, or prediction intervals.
[`simulate()`](https://rdrr.io/r/stats/simulate.html) draws marginal
Gaussian responses from the fitted model, and
[`update()`](https://rdrr.io/r/stats/update.html) refits a modified
specification.
...
The [comparison
vignette](https://aureliennicosiaulaval.github.io/lmmix/articles/comparison.md)
cites the primary software papers and official package documentation
