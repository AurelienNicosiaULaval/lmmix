...
Procedure*: <https://support.sas.com/documentation/onlinedoc/stat/>.

These are documentation-based comparisons. No claim is made that SAS was
run inside this repository. The full SAS manual is not redistributed.
