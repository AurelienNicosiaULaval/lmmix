...
the combined random-effect and correlated-residual case, Kenward-Roger has
structural tests but no fresh independent SAS execution. An archived SAS log
and output would be required to upgrade that evidence.
