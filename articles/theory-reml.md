...
by $`n-p`$ in the normalizing constant. Cholesky solves are used instead
of explicit matrix inverses.
...
the Fai-Cornelius moment-matching formula used by `lmerTest`.
